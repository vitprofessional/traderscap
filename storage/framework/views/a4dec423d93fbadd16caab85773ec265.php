                ...
                <div class="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-[0_14px_35px_rgba(15,23,42,0.08)]">
                    ...
                    <div class="px-6 pt-6 pb-4 text-center">
                        <div class="flex flex-wrap items-center justify-center gap-2">
                            <h3 id="selected-package-name" class="text-xl font-bold text-slate-900"><?php echo e($selectedPackage->name); ?></h3>
                            <span id="selected-package-recommended" class="inline-flex items-center rounded-full bg-orange-500 px-2.5 py-1 text-[9px] font-extrabold uppercase tracking-[0.2em] text-white shadow-sm" style="display: <?php echo e($selectedPackage->is_recommended ? 'inline-flex' : 'none'); ?>;">Recommended</span>
                        </div>
                    </div>

                    
                    <div class="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 px-6 py-6 text-center text-white">
                        <div id="selected-package-price" class="text-4xl font-black tracking-tighter"><?php echo e($formattedPrice); ?></div>
                        <div class="mt-1 text-sm font-semibold text-white/95">Min Deposit</div>
                    </div>

                    
                    <div id="selected-package-description-wrap" class="border-b border-slate-100 px-6 py-4 text-center <?php echo e($selectedPackage->description ? '' : 'hidden'); ?>">
                        <p id="selected-package-description" class="text-sm leading-6 text-slate-500"><?php echo e($selectedPackage->description); ?></p>
                    </div>
            ...
            <div class="lg:col-span-2">
                <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                    ...
                    <form
                        ...
                        method="POST"
                        action="<?php echo e(route('investment-plans.request.submit', $selectedPackage)); ?>"
                        data-submit-url-template="<?php echo e(route('investment-plans.request.submit', ['package' => '__PACKAGE__'])); ?>"
                        ...
                        <div>
                            ...
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $planOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        value="<?php echo e($id); ?>"
                                        data-price="<?php echo e($planMeta[$id]['price'] ?? 0); ?>"
                                        data-meta='<?php echo json_encode($planMeta[$id] ?? [], 15, 512) ?>'
                                        <?php if((int) old('package_id', $selectedPackage->id) === (int) $id): echo 'selected'; endif; ?>
                                    >
                                        <?php echo e($name); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="number"
                                    step="0.01"
                                    min="<?php echo e(number_format((float) $selectedPackage->price, 2, '.', '')); ?>"
                                    name="equity"
                                    value="<?php echo e(old('equity', $existingPackage?->equity ?? $selectedPackage->price)); ?>"
                                    placeholder="0.00"
                            ...
                            <p id="equity-min-hint" class="mt-1 text-xs text-slate-500">Minimum required for selected package: $<?php echo e(number_format((float) $selectedPackage->price, 2)); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <script>
        (function () {
            const preserveCredentialsOnPackageSwitch = <?php echo json_encode(
                $existingPackage

...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Create Support Ticket']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Create Support Ticket']); ?>
    <div class="mx-auto w-full max-w-3xl space-y-6 px-2 sm:px-4 lg:px-6">
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <form method="POST" action="<?php echo e(route('complaints.store')); ?>" enctype="multipart/form-data" class="space-y-0">
                <?php echo csrf_field(); ?>
                ...
                <div class="border-b border-slate-200 px-6 py-6 md:px-8">
                    ...
                    <input 
                        ...
                        class="mt-3 block w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm transition-colors focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 focus:outline-none <?php $__errorArgs = ['subject'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="border-b border-slate-200 px-6 py-6 md:px-8">
                    ...
                    <textarea 
                        ...
                        class="mt-3 block w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm transition-colors focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 focus:outline-none <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\traderscap\resources\views/customer/complaints/create.blade.php ENDPATH**/ ?>
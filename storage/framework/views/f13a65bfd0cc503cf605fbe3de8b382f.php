        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $brokers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $broker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="transition-colors hover:bg-slate-50">
                                <!-- Rank -->
                                <td class="px-6 py-4">
                                    <div class="flex h-10 w-10 items-center justify-center rounded-full font-bold text-sm text-white <?php echo e($index === 0 ? 'bg-gradient-to-br from-yellow-400 to-yellow-600' : ($index === 1 ? 'bg-gradient-to-br from-slate-400 to-slate-600' : ($index === 2 ? 'bg-gradient-to-br from-orange-400 to-orange-600' : 'bg-gradient-to-br from-blue-400 to-blue-600'))); ?>">
                                        #<?php echo e($index + 1); ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->logo): ?>
                                            <img src="<?php echo e(asset('storage/app/public/' . $broker->logo)); ?>" alt="<?php echo e($broker->name); ?>" class="h-12 w-12 flex-shrink-0 object-contain rounded-lg bg-slate-50 p-1" onerror="this.style.display='none'">
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div>
                                            <p class="font-semibold text-slate-900"><?php echo e($broker->name); ?></p>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->description): ?>
                                                <p class="text-xs text-slate-500 line-clamp-1 mt-0.5"><?php echo e($broker->description); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->rating): ?>
                                            <div class="flex gap-0.5">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 5; $i++): ?>
                                                    <svg class="h-4 w-4 <?php echo e($i < floor($broker->rating) ? 'fill-amber-400 text-amber-400' : 'fill-slate-200 text-slate-200'); ?>" viewBox="0 0 20 20">
                                                        <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/>
                                                    </svg>
                                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            <span class="font-semibold text-slate-900"><?php echo e($broker->rating); ?>/5</span>
                                        <?php else: ?>
                                ...
                                <td class="px-6 py-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->min_deposit): ?>
                                        <span class="font-semibold text-slate-900"><?php echo e($broker->min_deposit); ?></span>
                                    <?php else: ?>
                                        <span class="text-slate-500">—</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->years_in_business): ?>
                                        <span class="font-semibold text-slate-900"><?php echo e($broker->years_in_business); ?> yrs</span>
                                    <?php else: ?>
                                        <span class="text-slate-500">—</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->website): ?>
                                        <a href="<?php echo e($broker->website); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-full bg-cyan-600 px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-white transition-all hover:bg-cyan-700 active:scale-95">
                                            Visit
                                        </a>
                                    <?php else: ?>
            ...
            <div class="border-t border-slate-200 bg-slate-50 px-6 py-4">
                <p class="text-xs text-slate-600">
                    <span class="font-semibold text-slate-900"><?php echo e($brokers->count()); ?></span> brokers available • Ranked by rating, experience, and features
                </p>
            </div>
        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($brokers->first()): ?>
                    <div class="rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-amber-100 px-6 py-8 shadow-sm">
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <span class="text-2xl font-bold text-amber-700"><?php echo e($brokers->first()->rating); ?>/5</span>
                        </div>
                        <p class="mb-4 font-semibold text-slate-900"><?php echo e($brokers->first()->name); ?></p>
                        <?php if($brokers->first()->website): ?>
                            <a href="<?php echo e($brokers->first()->website); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-semibold text-amber-800 hover:text-amber-900 transition-colors">
                                Visit Site
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostExperienced): ?>
                        <div class="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-emerald-100 px-6 py-8 shadow-sm">
                            <div class="mb-6 flex items-center justify-between">
                                ...
                                <span class="text-2xl font-bold text-emerald-700"><?php echo e($mostExperienced->years_in_business); ?>+</span>
                            </div>
                            <p class="mb-4 font-semibold text-slate-900"><?php echo e($mostExperienced->name); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mostExperienced->website): ?>
                                <a href="<?php echo e($mostExperienced->website); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-semibold text-emerald-800 hover:text-emerald-900 transition-colors">
                                    Visit Site
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lowestDeposit): ?>
                        <div class="rounded-2xl border border-cyan-200 bg-gradient-to-br from-cyan-50 to-cyan-100 px-6 py-8 shadow-sm">
                            <div class="mb-6 flex items-center justify-between">
                                ...
                                <span class="text-2xl font-bold text-cyan-700"><?php echo e($lowestDeposit->min_deposit); ?></span>
                            </div>
                            <p class="mb-4 font-semibold text-slate-900"><?php echo e($lowestDeposit->name); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lowestDeposit->website): ?>
                                <a href="<?php echo e($lowestDeposit->website); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-semibold text-cyan-800 hover:text-cyan-900 transition-colors">
                                    Visit Site
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>

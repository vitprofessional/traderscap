...
<?php $component->withAttributes([]); ?>
    <div class="max-w-6xl w-full">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('investment-plans')); ?>" class="inline-flex items-center px-3 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700">Browse Plans</a>
        </div>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-100 align-top hover:bg-gray-50/60">
                                <td class="py-4 px-4 min-w-[220px]">
                                    <div class="font-semibold text-gray-900"><?php echo e($userPackage->package->name ?? '—'); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($userPackage->package?->facilities) && is_array($userPackage->package->facilities)): ?>
                                ...
                                <td class="py-4 px-4 whitespace-nowrap text-gray-700"><?php echo e($userPackage->starts_at ? $userPackage->starts_at->toFormattedDateString() : '—'); ?></td>
                                <td class="py-4 px-4 whitespace-nowrap text-gray-700"><?php echo e($userPackage->ends_at ? $userPackage->ends_at->toFormattedDateString() : '—'); ?></td>
                                ...
                                <td class="py-4 px-4 text-right whitespace-nowrap">
                                    <div class="inline-flex items-center gap-2">
                                        <a href="<?php echo e(route('investment-plans')); ?>" class="inline-flex items-center px-3 py-2 text-xs font-semibold bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors">
                                            Change Plan
                                        </a>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userPackage->status !== 'expired'): ?>
                                            <form method="POST" action="<?php echo e(route('my-plans.cancel', $userPackage)); ?>" class="inline">
                                                <?php echo csrf_field(); ?>

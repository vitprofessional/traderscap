                ...
                <div class="px-6 py-8 md:px-8">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <div class="space-y-8">
                            ...
                            <!-- Min Deposit -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userPackage->package?->price): ?>
                                <div>
                                    <p class="text-xs font-semibold uppercase tracking-[0.08em] text-slate-600 mb-2">Min Deposit</p>
                                    <p class="text-3xl font-bold text-blue-700">$<?php echo e(number_format($userPackage->package->price, 0)); ?></p>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

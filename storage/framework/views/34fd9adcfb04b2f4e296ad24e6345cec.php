...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
                    ...
                    <div class="p-6 flex flex-col gap-4">
                        ...
                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center justify-center gap-2 w-full rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-semibold px-4 py-3 transition-colors">
                            Submit MT4 Details
                    ...
                    <div class="p-4 flex flex-col gap-3">
                        <div class="flex items-center gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($broker->logo): ?>
                                <img src="<?php echo e($broker->logo); ?>" alt="<?php echo e($broker->name); ?>" class="w-8 h-8 rounded-lg object-contain bg-slate-50 border border-slate-100">
                            <?php else: ?>
                ...
                <div class="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
                    ...
                    <div class="p-5 flex flex-col gap-2 <?php echo e($pkg->is_recommended ? 'bg-cyan-50' : ''); ?>">
                        ...
                        <div class="flex items-baseline gap-1">
                            ...
                            <span class="text-xs text-slate-500">/ <?php echo e($pkg->duration_type); ?></span>
                        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userPackages->isNotEmpty()): ?>
            <div class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-5 py-3.5 text-slate-500"><?php echo e($up->starts_at?->format('M d, Y') ?? '-'); ?></td>
                                <td class="px-5 py-3.5 text-slate-500"><?php echo e($up->ends_at?->format('M d, Y') ?? '-'); ?></td>

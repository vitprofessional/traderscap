        ...
        <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
            <ul class="space-y-1.5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li>
                        <a href="<?php echo e($routeUrl); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-150 <?php echo e($isActive ? 'bg-cyan-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-700/50 hover:text-slate-50'); ?>">
                            <!-- Icon -->
                            <span class="flex-shrink-0 w-5 h-5 flex items-center justify-center <?php echo e($isActive ? 'text-cyan-100' : 'text-slate-400 group-hover:text-slate-300'); ?>">
                            ...
                            <!-- Label -->
                            <span class="text-sm font-medium flex-1"><?php echo e($it['label']); ?></span>
    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="flex items-center justify-between px-6 py-5 bg-white border-b border-slate-200 shadow-sm">
            ...
            <div class="flex items-center gap-5">
                ...
                <!-- Page Title -->
                <div>
                    <h3 class="text-xl font-bold text-slate-900"><?php echo e($title ?? 'Dashboard'); ?></h3>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    ...
                    <div id="notifications-menu" class="absolute right-0 mt-2 w-80 bg-white rounded-xl border border-slate-200 shadow-lg opacity-0 invisible transition-all duration-200 z-50" style="pointer-events: none;">
                        ...
                        <div class="border-t border-slate-200 px-4 py-3">
                            <a href="<?php echo e(route('complaints')); ?>" class="text-xs font-semibold text-cyan-600 hover:text-cyan-700">View all notifications →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="user-menu" class="absolute right-0 mt-2 w-56 bg-white rounded-xl border border-slate-200 shadow-lg opacity-0 invisible transition-all duration-200 z-50" style="pointer-events: none;">
                            <div class="px-4 py-3 border-b border-slate-200">
                                <p class="text-sm font-semibold text-slate-900"><?php echo e($u->name ?? 'Guest'); ?></p>
                                <p class="text-xs text-slate-500 mt-1"><?php echo e($u->email ?? 'guest@example.com'); ?></p>
                            </div>
                            <div class="py-2">
                                <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    <span>My Profile</span>
                                </a>
                                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="hidden sm:block">
                        <div class="text-sm font-semibold text-slate-900"><?php echo e($u->name ?? 'Guest'); ?></div>

...
<?php $component->withAttributes(['title' => 'Support Tickets']); ?>
    <div class="max-w-4xl w-full">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('complaints.create')); ?>" class="px-4 py-2 bg-indigo-600 text-white rounded">New Ticket</a>
        </div>
                ...
                <ul>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="p-4 border-b flex items-center justify-between">
                            <div>
                                <a href="<?php echo e(route('complaints.show',$t)); ?>" class="font-medium text-indigo-600">#<?php echo e($t->id); ?> — <?php echo e($t->subject); ?></a>
                                <div class="text-sm text-gray-500"><?php echo e(ucfirst($t->status)); ?> • <?php echo e($t->created_at->diffForHumans()); ?></div>
                            </div>
                            <div class="text-sm text-gray-600">Priority: <?php echo e(ucfirst($t->priority)); ?></div>
                        </li>

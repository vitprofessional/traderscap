...
<?php $component->withAttributes([]); ?>
    <div class="max-w-6xl w-full">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div class="mb-4 p-3 bg-green-50 text-green-800 rounded"><?php echo e(session('success')); ?></div>
            ...
            <section class="rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-900 to-fuchsia-900 p-5 md:p-8 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <article class="rounded-xl overflow-hidden border <?php echo e($isCurrentPlan ? 'border-emerald-300 ring-2 ring-emerald-300/70 shadow-xl' : ($isFeatured ? 'border-fuchsia-300 shadow-xl ring-1 ring-fuchsia-300/60' : 'border-slate-200 shadow-lg')); ?> bg-white">
                            <div class="px-5 py-4 <?php echo e($isFeatured ? 'bg-fuchsia-600 text-white' : 'bg-slate-600 text-white'); ?>">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        <h4 class="text-lg font-semibold"><?php echo e($plan->name); ?></h4>
                                        <p class="text-xs <?php echo e($isFeatured ? 'text-fuchsia-100' : 'text-slate-200'); ?> mt-1"><?php echo e((int) $plan->duration_days); ?> days plan</p>
                                    </div>
                                ...
                                <div class="mt-3">
                                    <span class="text-4xl font-bold leading-none">$<?php echo e(number_format($plan->price, 0)); ?></span>
                                    <span class="text-xs <?php echo e($isFeatured ? 'text-fuchsia-100' : 'text-slate-200'); ?>"> /<?php echo e((int) $plan->duration_days); ?> days</span>
                                </div>
                            </div>

                            <div class="px-5 py-4">
                                <p class="text-xs text-gray-600 leading-relaxed min-h-10"><?php echo e($plan->description ?: 'No details provided.'); ?></p>
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                    <a href="<?php echo e(route('investment-plans.request', $plan)); ?>" class="mt-5 w-full inline-flex justify-center items-center px-3 py-2.5 rounded-full text-xs font-semibold tracking-wide uppercase <?php echo e($isFeatured ? 'bg-fuchsia-600 hover:bg-fuchsia-700 text-white' : 'bg-slate-700 hover:bg-slate-800 text-white'); ?> transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="px-4 py-2 border-b border-gray-200 text-2xl font-semibold text-slate-900"><?php echo e($step['number']); ?></div>
                            <div class="px-4 py-3 bg-cyan-600 text-white text-3xl font-semibold leading-none"><?php echo e($step['title']); ?></div>
                            <div class="p-4">

...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - Customer Login</title>
...
<body>
    <main class="login-shell" aria-label="Customer login page">
        <section class="login-brand" aria-hidden="true">
            <div>
                <span class="badge"><?php echo e(config('app.name')); ?> Portal</span>
        ...
        <section class="login-card">
            ...
            <p class="meta">Need an account? <a href="<?php echo e(route('register')); ?>">Create one here</a>.</p>
        </section>
    </main>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\traderscap\resources\views/auth/login.blade.php ENDPATH**/ ?>